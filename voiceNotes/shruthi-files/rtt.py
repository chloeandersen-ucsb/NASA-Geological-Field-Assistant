'''
LOCALLY TESTED ON MACBOOK NOT YET JETSON ORIN COMPATIBLE (last update 12/03/25)
- better accuracy on rolling window (best accuracy so far)
- clean readable final transcript implemented (accuracy needs improvement)
'''
...
if segments:
    ...
    end_ts = segments[-1]["end"]
    print("FINAL TRANSCRIPT:\n")
    print(f"[{start_ts} - {end_ts}] {final_transcript}")
else:
